...
const AssignAssets = ({ users }) => {
    ...
    React.useEffect(() => {
        axios.get('http://localhost:8000/getuserassets')
            .then((res) => {
    ...
    React.useEffect(() => {
        if (key) {
            axios({
                method: 'put',
                url: 'http://localhost:8000/getasset',
                data: {
                    [newAsset]: newAsset
                }
            })
    ...
    const handleAssign = () => {
        axios({
            method: 'post',
            url: 'http://localhost:8000/userassets',
            data: {
                username: user,
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <Box sx={{ width: '50%' }}>
                <Card sx={{ backgroundImage: `url(${background})`, height: '100vh' }}>
                    <Typography
                        sx={{ color: 'white' }}
                        variant='h5'
                        component='div'
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', mt: 5 }}>
                        <Typography sx={{ mr: 10, mt: 2, color: 'white' }}>User</Typography>
                        <Select
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', mt: 10 }}>
                        <Typography sx={{ mr: 10, mt: 2, color: 'white' }}>Assets</Typography>
            ...
            <Box sx={{ width: '50%', backgroundImage: `url(${background})` }}>
                <Card sx={{ backgroundImage: `url(${background})` }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', mt: 5 }}>
                        <Typography sx={{ mr: 8, mt: 2, color: 'white' }}>Chart Type</Typography>
                        <Select
                            sx={{ width: 300, backgroundColor: 'white', color: 'black', borderRadius: '50px' }}
                            value={chart}
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', mt: 10 }}>
                        <Typography sx={{ mr: 10, mt: 2, color: 'white' }}>Month  </Typography>
                        <Select
                            sx={{ width: 300, backgroundColor: 'white', color: 'black', borderRadius: '50px' }}
                            value={month}
